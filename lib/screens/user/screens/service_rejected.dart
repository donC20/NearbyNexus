...
class ServiceRejected extends StatefulWidget {
  const ServiceRejected({super.key});

  @override
  State<ServiceRejected> createState() => _ServiceRejectedState();
}

class _ServiceRejectedState extends State<ServiceRejected> {
