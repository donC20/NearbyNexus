      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                profileLists(Icons.mail, email, "Email", false),
                profileLists(Icons.phone, phone, "Phone", true),
                profileLists(Icons.location_city_outlined, city, "City", true),
                profileLists(Icons.home_work, city, "Address", true),
                Padding(
                  padding:
                  ...
                  child: Column(
                    children: [
                      ...
                      proposedJobs("Auto rickshaw", "Koovapally, Kerala, India",
                          "27/08/2023", false, "Mohan Babu"),
                      proposedJobs("Auto rickshaw", "Koovapally, Kerala, India",
                          "27/08/2023", true, "Mohan Babu"),
                    ],
                  ),
                ),
              ],
...
Widget profileLists(IconData icon, value, title, isEditable) {
  return Padding(
